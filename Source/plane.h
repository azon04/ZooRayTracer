...
public:
	xy_rect() {}
	xy_rect(float _x0, float _x1, float _y0, float _y1, float _k, material* _mat) : x0(_x0), x1(_x1), y0(_y0), y1(_y1), k(_k), mat(_mat) {}
...
public:
	xz_rect() {}
	xz_rect(float _x0, float _x1, float _z0, float _z1, float _k, material* _mat) : x0(_x0), x1(_x1), z0(_z0), z1(_z1), k(_k), mat(_mat)  {}
	virtual bool hit(const ray& r, float t_min, float t_max, hit_record& rec) const;
	virtual bool bounding_box(float t0, float t1, aabb& box) const
	{
...
public:
	yz_rect() {}
	yz_rect(float _y0, float _y1, float _z0, float _z1, float _k, material* _mat) : y0(_y0), y1(_y1), z0(_z0), z1(_z1), k(_k), mat(_mat) {}
	virtual bool hit(const ray& r, float t_min, float t_max, hit_record& rec) const;
	virtual bool bounding_box(float t0, float t1, aabb& box) const
	{
